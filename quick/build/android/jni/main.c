...
JNIEXPORT void JNICALL
Java_com_engine_gl2jni_GL2JNILib_ondestroy(JNIEnv *env, jobject obj) {
	ejoy2d_win_release();
	font_module_destroy();
}

JNIEXPORT void JNICALL
Java_com_engine_gl2jni_GL2JNILib_onsurfacechanged(JNIEnv *env, jobject obj, jint width, jint height) {
	if (inited) {
		ejoy2d_win_release();
	}
...
JNIEXPORT void JNICALL
Java_com_engine_gl2jni_GL2JNILib_ontouchevent(JNIEnv *env, jobject obj, jint x, jint y, jint touch) {
